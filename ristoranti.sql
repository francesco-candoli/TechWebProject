...
(2, 'L utente1 ti ha messo like alla recensione: 2', ''),
(8, 'L utente marchito92 ti ha messo like alla recensione: 4', ''),
(9, 'L utente coolguy ti ha messo like alla recensione del ristorante:  Uliassi', 'profile/coolguy');
...
INSERT INTO `review` (`id`, `content`, `vote`, `restaurant_id`, `publisher_id`,`date`) VALUES
(1, 'content', 2, 5, 2, '2023-03-23'),
(2, 'content', 3, 7, 3, '2023-02-21'),
(3, 'content', 4, 9, 3, '2023-03-07'),
(4, 'content', 1, 3, 1, '2023-03-12');
